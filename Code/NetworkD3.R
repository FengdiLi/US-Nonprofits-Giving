...
D3_network_LM <- networkD3::forceNetwork(Links = edgeList, # data frame that contains info about edges
  ...
  htmlwidgets::prependContent(htmltools::tags$h2("Network: Top Nonprofits Category per State"))

# Plot network
D3_network_LM 

# Save network as html file
networkD3::saveNetwork(D3_network_LM, "NetworkD3.html", selfcontained = TRUE)
